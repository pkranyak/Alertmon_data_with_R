...
network_id <- 202
network_list <- c(3, 242, 212, 7, 10)
## Other variables to set
start_time <- as.integer(as.POSIXct("2025-05-01 00:00:00", tz = "UTC"))
end_time   <- as.integer(as.POSIXct("2025-06-01 00:00:00", tz = "UTC"))
username <- "pkranyak"
...
file_name <- "OmniSOC_2025_05_01-2025_05_31"
